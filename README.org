...
- Anime Games Launcher requires rust-1.92 which is not yet avaliable on Guix.
  After Guix adds rust-1.92 [[https://codeberg.org/ch4og/aagl-guix/pulls/1][PR]] with addition will be merged
- On NVIDIA animated backgrounds currently do not work on Wayland.
  - Technically speaking it fully works when the driver is passed,
